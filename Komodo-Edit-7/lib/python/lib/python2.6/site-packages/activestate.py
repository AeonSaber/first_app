#!/usr/bin/env python
# Copyright (c) 2002-2010 ActiveState Software Inc.  All rights reserved.
...
version_info = {'bsddb_ver': None,
 'build_host': 'vm-centos50-trentm',
 'build_num': 13,
 'build_plat_fullname': 'linux2.6-centos5.4-libc6-glibc2.5-libcpp6-x86',
 'build_plat_name': 'linux-x86',
 'build_time': 'Tue Apr  6 10:11:02 2010',
 'bzip2_ver': (1, 0, 5),
 'compiler': 'gcc',
 ...
 'platinfo': {'arch': 'x86',
              ...
              'distro_desc': 'CentOS release 5.4 (Final)',
              'distro_ver': '5.4',
              'glibc': 'glibc',
              'glibc_ver': '2.5',
              'libc': 'libc6',
              'libcpp': 'libcpp6',
              'lsb_version': ':core-3.1-ia32:core-3.1-noarch:graphics-3.1-ia32:graphics-3.1-noarch',
              'os': 'linux',
              'os_ver': '2.6.18'},
 'platname': 'linux-x86',
 ...
 'python_src': ('2.6.5',
                'url',
                'http://crimper.activestate.com/apps/ActivePython/src/Python-2.6.5.tgz'),
 'pywin32_build': None,
 'pywin32_src': None,
 'pywin32_ver': None,
 'scm_revision': 'rDEV',
...
compiler_info = """gcc (GCC) 4.1.2 20080704 (Red Hat 4.1.2-46)"""


# Used for Python install relocation.
prefixes = set([
    # Prefix to which extensions were built
    '/home/student/Komodo-Edit-7/lib/python',
...
shortest_original_prefix_length = 280
